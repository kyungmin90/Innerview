    ...
    <footer class="footer">
      <div class="container">
        <div class="row">
          <div class="col-lg-3 mb-4 mb-lg-0">
            ...
            <p class="text-muted text-small">Joint C.E.O: jaehwa, junghoon, kyungmin, changhee, jungwoo </p>
            <p class="text-muted text-small">3rd project java android - the joeun computer academy.</p>
      ...
      <div class="copyrights">       
        <div class="container text-center py-4">
          <p class="mb-0 text-muted"> 2020, 3rd project. &copy; designed by <a href="#">3rd project</a>.</p>
        </div>
      </div>
    </footer></html>